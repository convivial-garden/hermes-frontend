                  ...
                  <Row>
                    <Col xs={12}>
                      <div className='d-flex flex-wrap'>
                        {contract.repeated.days_of_the_week
                          .split(',')
                          .map((day) =>
                            day.trim() !== '' && day.trim().length > 3 ? (
                              <div key={day}>{WEEKDAYS[day.trim()]}, </div>
                            ) : (
                              ''
                            ),
                          )}
                      ...
                      <div>
                        Ab{' '}
                        {moment(contract.repeated.start_date).format(
                          'DD.MM.yyyy',
                        )}
                        &nbsp;
                        {moment(contract.repeated.end_date).isValid()
                          ? `bis ${moment(contract.repeated.end_date).format(
                              'DD.MM.yyyy',
                            )}`
                          : ''}
                      </div>

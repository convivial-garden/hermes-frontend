...
function CustomerDetail({
  ...
  const SECONDCOLWIDTH = 9;
  return (
    <Row>
      <Col xs={12} className={customer.has_delayed_payment ? `${cl} bto expad delayed-payment` : `${cl} bto expad `}>
        <Row>
          <Col xs={3}>
            <Row>
              ...
              <Col xs={SECONDCOLWIDTH}>
                {customer.has_delayed_payment
                  && <FontAwesomeIcon icon={faBell} size="lg" className="text-danger pe-2" />}
                {customer.name}
              </Col>
            </Row>
          </Col>
          ...
          <Col xs={2}>
            ...
            <Row>
              ...
              {customer.has_delayed_payment
                ? (
                  <Col xs={2}>
                    <DeleteDelayedPaymentModal customer={customer} update={update} />
                  </Col>
                )
                : ''}
            </Row>
          ...
          <Col xs={1}>
            <CustomerFormModal customer={customer} cl={cl} update={update} refresh={refresh} />
          </Col>
        </Row>
        <Row>
          <Col xs={12}>

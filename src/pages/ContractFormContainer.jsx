...
import ContractBonusButtons from '../components/ContractBonusButtons';
import { ContractFormRepresentational } from '../components/ContractFormRepresentational';
import {
  getAnon,
  postNewContract,
  putContract,
      ...
      axios
        .all(
          delayedPaymentAndCustomerRequests.concat(
            this.state.positionsDeleteRequests.map((url) => axios.delete(url)),
          ),
        )
        .then(() => {
    ...
    return (
      <Container fluid>
        ...
        <Row>
          ...
          <Col xs={1} style={{ marginTop: '200px' }}>
            <div>
